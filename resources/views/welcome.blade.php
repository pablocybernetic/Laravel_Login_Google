...
<head>
  ...
  <link id="pagestyle" href="{{url('storage/assets/css/main.css')}}" rel="stylesheet" />
...
<body class="index-page">
          ...
          <div class="container-fluid px-0">
            ...
            <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
              <ul class="navbar-nav navbar-nav-hover ms-lg-12 ps-lg-5 w-100">
                ...
                @if (Route::has('login'))
                @auth
                <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Dashboard <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></a>
                @else
                <li class="nav-item my-auto ms-3 ms-lg-0">
                  <a href="{{ route('login') }}" class="btn btn-sm btn-info text-white btn-round mb-0 me-1 mt-2 mt-md-0">Login</a>
                </li>
                @if (Route::has('register'))
                <li class="nav-item my-auto ms-3 ms-lg-0">

                  <a href="{{ route('register') }}" class="btn btn-sm  bg-info text-white  btn-round mb-0 me-1 mt-2 mt-md-0">Register</a>
  ...
  <header class="header-2">
    <div class="page-header min-vh-75 relative" style="background-image:url('storage/assets/img/curved-images/curved.jpg')">
      <div class="container">
        <div class="row">
          <div class="col-lg-7 text-center mx-auto">
            <h1 class="text-white pt-3 mt-n5">Denzmovers Relocation made easy</h1>
        ...
        <div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4">
          <div class="card card-background card-background-mask-primary tilt" data-tilt>
            ...
            <div class="card-body pt-7 text-center">
              ...
              <a href="" target="_blank" class="btn btn-outline-white text-white mt-5 up btn-round">Get a free quote</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="my-5 py-5">
    ...
    <!--   Core JS Files   -->
    <script src="{{url('storage/assets/js/core/popper.min.js')}}" type="text/javascript"></script>
    <script src="{{url('storage/assets/js/core/bootstrap.min.js')}}" type="text/javascript"></script>
    ...
    <script src="{{url('storage/assets/js/plugins/countup.min.js')}}"></script>





    <script src="{{url('storage/assets/js/plugins/choices.min.js')}}"></script>





    <script src="{{url('storage/assets/js/plugins/prism.min.js')}}"></script>
    <script src="{{url('storage/assets/js/plugins/highlight.min.js')}}"></script>
    ...
    <script src="{{url('storage/assets/js/plugins/rellax.min.js')}}"></script>
    <!--  Plugin for TiltJS, full documentation here: https://gijsroge.github.io/tilt.js/ -->
    <script src="{{url('storage/assets/js/plugins/tilt.min.js')}}"></script>
    <!--  Plugin for Selectpicker - ChoicesJS, full documentation here: https://github.com/jshjohnson/Choices -->
    <script src="{{url('storage/assets/js/plugins/choices.min.js')}}"></script>


    <!--  Plugin for Parallax, full documentation here: https://github.com/wagerfield/parallax  -->
    <script src="{{url('storage/assets/js/plugins/parallax.min.js')}}"></script>
    ...
    <script src="{{url('storage/assets/js/soft-design-system.min.js?v=1.0.9" type="text/javascript"></script>
